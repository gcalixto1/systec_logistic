...
<div class="container-fluid">
    <div class="card-header">
        <h4 class="card-title text-black"><i class="fa fa-box"></i> Gestion de Presentacion de producto</h4>
    </div>
    <br>
    <div class="col-lg-12">
        ...
        <table class="table table-responsive" id="borrower-list">
            ...
            <tbody>
                <?php
                $i = 1;
                $qry = $conexion->query("SELECT * FROM presentacion");
                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap;">
                            <button class="btn btn-success btn-sm edit_borrower" type="button"
                                data-id="<?php echo $row['idpresentacion'] ?>">
