...
<div class="container-fluid">
    <div class="card-header">
        <h4 class="card-title text-black"><i class="fa fa-box"></i> Gestion de Almacen</h4>
    </div>
    <br>
    <div class="col-lg-12">
        ...
        <table class="table table-responsive" id="borrower-list">
            ...
            <tbody>
                <?php
                $i = 1;
                $qry = $conexion->query("SELECT * FROM almacenes");
...
<script>
    ...
    $('#new_categoria').click(function() {
        uni_modal("Gestion de Almacenes", "manage_almacen.php")
    })
    $('#borrower-list').on('click', '.edit_borrower', function() {
        uni_modal("Modificar Almacen", "manage_almacen.php?id=" + $(this).attr('data-id'))
    })
    ...
    function delete_borrower($idproveedor) {
        start_load()
        $.ajax({
            url: 'ajax.php?action=delete_almacen',
            method: 'POST',
            data: {
                id: $idproveedor
            },
